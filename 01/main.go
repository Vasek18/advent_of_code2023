...
func main() {
	...
	for _, line := range lines {
		number, _ := getNumberFromString(line)
...
func getNumberFromString(input string) (int, error) {
	var firstNumeric rune = 0
	var lastNumeric rune = 0
	...
	if lastNumeric == 0 {
		return strconv.Atoi(fmt.Sprintf("%c", firstNumeric))
	}

	return strconv.Atoi(fmt.Sprintf("%c%c", firstNumeric, lastNumeric))
}
